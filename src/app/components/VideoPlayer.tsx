...
export default function VideoPlayer({ videoId, title, size = 'default' }: VideoPlayerProps) {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-black/20 pointer-events-none z-10 transition-opacity duration-300 ${
      ...
      {!isPlaying && (
        ...
        >
          <div className="relative">
            ...
            {/* Play button */}
            <div className="relative flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-white/95 backdrop-blur-md shadow-2xl border-3 border-white/60 transition-all duration-300 group-hover/play:scale-110 group-hover/play:shadow-[0_0_50px_rgba(255,107,53,0.5)]">
