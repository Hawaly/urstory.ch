...
export default function PremiumFooter() {
  return (
    <footer className="relative px-4 py-6 md:px-6 overflow-hidden bg-gradient-to-b from-orange-500/5 via-orange-500/3 to-transparent">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="text-center mb-4">
          <Link href="#hero" className="inline-block group">
            <Image 
              ...
              width={160} 
              height={45}
              className="h-10 w-auto mx-auto transition-all duration-300 group-hover:scale-105"
              priority={false}
            />
          </Link>
        </div>
        ...
        <nav className="flex flex-wrap items-center justify-center gap-6 mb-4" aria-label="Footer Navigation">
          {NAV_LINKS.map((link) => (
            <a 
              key={link.href} 
              href={link.href} 
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-6">
          <span className="text-sm font-medium text-gray-700">Nous contacter</span>
          ...
          <div className="flex items-center gap-3">
            <a 
              ...
              className="inline-flex items-center justify-center h-10 w-10 rounded-xl border-2 border-white/60 bg-white/50 backdrop-blur-xl text-gray-600 transition-all duration-300 hover:border-orange-500/50 hover:bg-orange-500/10 hover:text-orange-500 hover:scale-110"
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          {/* Legal Links */}
          <div className="flex flex-wrap items-center justify-center gap-5 text-sm text-gray-500 order-3 lg:order-2">
          ...
          <div className="order-1 lg:order-3">
            <CalendlyButton className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-orange-600 to-orange-500 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-orange-500/25 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/30">
